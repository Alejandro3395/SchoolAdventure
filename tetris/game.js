...
var leftRutilio=true;
var rigtRutilio= false;
...
Game.preload = function() {
    ...
    game.load.image('rutilio', 'assets/rutilio.png');
    game.load.image('buttonhome','assets/button.png');  
...
Game.create = function(){
    ...
    rutilio = game.add.sprite(800, 400, 'rutilio'); //910 desaparece , 800 aparece
    rutilio2 = game.add.sprite(-203,50,'rutilio'); //-193 desaparece, -93 aparece
...
Game.update = function(){
    ...
    if(score>=50*nextMoveRutilio && rutilio.x <= 910 && leftRutilio){

        rutilio.x = rutilio.x +1;
        rutilio2.x = rutilio2.x +1;
        if(rutilio2.x== -93){
            nextMoveRutilio +=1;
            leftRutilio =false;
            rigtRutilio =true;
    ...
    }else if(score>=50*nextMoveRutilio && rutilio2.x >=-203 && rigtRutilio){
        rutilio2.x -= 1;
        rutilio.x -=1
