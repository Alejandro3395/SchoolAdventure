...
Game.preload = function() {
    game.load.spritesheet('blocks','assets/Tetris/blocks.png',blockSize,blockSize,nbBlockTypes+1);
    game.load.spritesheet('sound','assets/Tetris/sound.png',32,32); // Icon to turn sound on/off
    game.load.audio('move','assets/Tetris/sound/move.mp3','assets/sound/move.ogg');
    game.load.audio('win','assets/Tetris/sound/win.mp3','assets/sound/win.ogg');
    game.load.audio('gameover','assets/Tetris/sound/gameover.mp3','assets/sound/gameover.ogg');
    game.load.bitmapFont('desyrel', 'assets/Tetris/fonts/desyrel.png', 'assets/Tetris/fonts/desyrel.xml');
};
